Name:          openstack-heat-virtualenv-python-httplib2
Version:       0.8
Release:       1%{?dist}
Summary:       python-httplib2 installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-httplib2 for heat into virtualenv. Initial spec created.
