Name:          openstack-heat-virtualenv-python-pyyaml
Version:       3.10
Release:       1%{?dist}
Summary:       python-pyyaml installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-pyyaml for heat into virtualenv. Initial spec created.
