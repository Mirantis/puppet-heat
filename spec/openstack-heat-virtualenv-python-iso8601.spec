Name:          openstack-heat-virtualenv-python-iso8601
Version:       0.1.4
Release:       1%{?dist}
Summary:       python-iso8601 installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       iso8601-%{version}.tar.gz
...
- python-iso8601 for heat into virtualenv. Initial spec created.
