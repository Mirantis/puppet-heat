Name:          openstack-heat-virtualenv-python-lxml
Version:       3.2.3
Release:       1%{?dist}
Summary:       python-lxml installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-lxml for heat into virtualenv. Initial spec created.
