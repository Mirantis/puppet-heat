Name:          openstack-heat-virtualenv-python-pytz
Version:       2013b
Release:       1%{?dist}
Summary:       python-pytz installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       pytz-%{version}.zip
...
- python-pytz for heat into virtualenv. Initial spec created.
