Name:          openstack-heat-virtualenv-python-keystoneclient
Version:       0.3.1
Release:       1%{?dist}
Summary:       python-keystoneclient ionstalled into virtual env for openstack-heat
License:       ASL 2.0
...
- python-keystoneclient for heat into virtualenv. Initial spec created.
