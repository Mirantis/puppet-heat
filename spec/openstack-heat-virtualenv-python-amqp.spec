Name:          openstack-heat-virtualenv-python-amqp
Version:       1.0.13
Release:       1%{?dist}
Summary:       python-amqp installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       amqp-%{version}.tar.gz
...
- python-amqp for heat into virtualenv. Initial spec created.
