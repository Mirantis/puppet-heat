Name:          openstack-heat-virtualenv-python-paramiko
Version:       1.11.0
Release:       1%{?dist}
Summary:       python-paramiko installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       paramiko-%{version}.tar.gz
Source1:       openstack-heat-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-heat-virtualenv-python-pycrypto-2.6-1.el6.noarch.rpm
BuildArch:     noarch
...
rpm -e openstack-heat-virtualenv-python-pycrypto
...
- python-paramiko for heat into virtualenv. Initial spec created.
