Name:          openstack-heat-virtualenv-python-alembic
Version:       0.6.0
Release:       1%{?dist}
Summary:       python-alembic installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       alembic-%{version}.tar.gz
Source1:       openstack-heat-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-heat-virtualenv-python-sqlalchemy-0.7.10-1.el6.noarch.rpm
Source3:       openstack-heat-virtualenv-python-argparse-1.2.1-1.el6.noarch.rpm
Source4:       openstack-heat-virtualenv-python-markupsafe-0.18-1.el6.noarch.rpm
Source5:       openstack-heat-virtualenv-python-mako-0.8.1-1.el6.noarch.rpm
...
Requires: openstack-heat-virtualenv-python-mako
Requires: openstack-heat-virtualenv-python-argparse
Requires: openstack-heat-virtualenv-python-sqlalchemy
...
for FILE in `rpm -ql openstack-heat-virtualenv-python-markupsafe`;
do 

    test -f $FILE && rm -f $FILE; 
done

rpm -e openstack-heat-virtualenv-python-mako
rpm -e openstack-heat-virtualenv-python-markupsafe
rpm -e openstack-heat-virtualenv-python-argparse
rpm -e openstack-heat-virtualenv-python-sqlalchemy
...
- python-alembic for heat into virtualenv. Initial spec created.
