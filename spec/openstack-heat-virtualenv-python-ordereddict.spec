Name:          openstack-heat-virtualenv-python-ordereddict
Version:       1.1
Release:       1%{?dist}
Summary:       python-ordereddict installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       ordereddict-%{version}.tar.gz
...
- python-ordereddict for heat into virtualenv. Initial spec created.
