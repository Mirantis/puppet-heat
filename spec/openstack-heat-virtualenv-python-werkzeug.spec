Name:          openstack-heat-virtualenv-python-werkzeug
Version:       0.9.3
Release:       1%{?dist}
Summary:       python-werkzeug ionstalled into virtual env for openstack-heat
License:       ASL 2.0
...
%description
werkzeug in virtual environment for openstack-heat
...
- python-werkzeug for heat into virtualenv. Initial spec created.
