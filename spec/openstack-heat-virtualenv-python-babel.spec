Name:          openstack-heat-virtualenv-python-babel
Version:       1.3
Release:       1%{?dist}
Summary:       python-babel installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       Babel-%{version}.tar.gz
Source1:       openstack-heat-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-heat-virtualenv-python-pytz-2013b-1.el6.noarch.rpm
BuildArch:     noarch
 
BuildRequires: python-virtualenv
Requires: python-virtualenv
Requires: openstack-heat-virtualenv
Requires: openstack-heat-virtualenv-python-pytz
...
# Cleanup    
rpm -e openstack-heat-virtualenv-python-pytz
...
- python-babel for heat into virtualenv. Initial spec created.
