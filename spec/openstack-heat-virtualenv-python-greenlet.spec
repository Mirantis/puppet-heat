Name:          openstack-heat-virtualenv-python-greenlet
Version:       0.4.1
Release:       1%{?dist}
Summary:       python-greenlet installed into virtual env for openstack-heat
License:       ASL 2.0
...
( rpm -qa | grep openstack-heat-virualenv-python-markupsafe ) && echo  openstack-heat-virualenv-python-markupsafe must be installed during build process
...
- python-greenlet for heat into virtualenv. Initial spec created.
