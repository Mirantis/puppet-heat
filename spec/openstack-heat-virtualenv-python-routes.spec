Name:          openstack-heat-virtualenv-python-routes
Version:       1.13
Release:       1%{?dist}
Summary:       python-routes installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       Routes-%{version}.tar.gz
Source1:       openstack-heat-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-heat-virtualenv-python-repoze-lru-0.6-1.el6.noarch.rpm
...
Requires: openstack-heat-virtualenv-python-repoze-lru
...
# Cleanup    
rpm -e openstack-heat-virtualenv-python-repoze-lru
...
- python-routes for heat into virtualenv. Initial spec created.
