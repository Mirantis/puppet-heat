Name:          openstack-heat-virtualenv-python-pyparsing
Version:       1.5.7
Release:       1%{?dist}
Summary:       python-pyparsing installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-pyparsing for heat into virtualenv. Initial spec created.
