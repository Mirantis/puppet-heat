Name:          openstack-heat-virtualenv-python-flask
Version:       0.9
Release:       1%{?dist}
Summary:       python-flask ionstalled into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       Flask-%{version}.tar.gz
Source1:       openstack-heat-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-heat-virtualenv-python-markupsafe-0.18-1.el6.noarch.rpm
Source3:       openstack-heat-virtualenv-python-jinja2-2.7.1-1.el6.noarch.rpm
Source4:       openstack-heat-virtualenv-python-werkzeug-0.9.3-1.el6.noarch.rpm
...
Requires: openstack-heat-virtualenv-python-markupsafe
Requires: openstack-heat-virtualenv-python-jinja2
Requires: openstack-heat-virtualenv-python-werkzeug
...
%description
flask in virtual environment for openstack-heat
...
# Cleanup    
rpm -e openstack-heat-virtualenv-python-jinja2
rpm -e openstack-heat-virtualenv-python-werkzeug
...
- python-flask for heat into virtualenv. Initial spec created.
