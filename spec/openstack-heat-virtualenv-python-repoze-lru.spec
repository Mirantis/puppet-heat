Name:          openstack-heat-virtualenv-python-repoze-lru
Version:       0.6
Release:       1%{?dist}
Summary:       python-repoze.lru installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       repoze.lru-%{version}.tar.gz
...
- python-repoze.lru for heat into virtualenv. Initial spec created.
