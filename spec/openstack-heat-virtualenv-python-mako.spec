Name:          openstack-heat-virtualenv-python-mako
Version:       0.8.1
Release:       1%{?dist}
Summary:       python-mako installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-mako for heat into virtualenv. Initial spec created.
