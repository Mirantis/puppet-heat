Name:          openstack-heat-virtualenv-python-novaclient
Version:       2.14.1
Release:       1%{?dist}
Summary:       python-novaclient ionstalled into virtual env for openstack-heat
License:       ASL 2.0
...
- python-novaclient for heat into virtualenv. Initial spec created.
