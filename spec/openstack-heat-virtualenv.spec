Name:          openstack-heat-virtualenv
Version:       0.1
Release:       1%{?dist}
Summary:       Virtual env for openstack-heat
License:       ASL 2.0
...
%changelog
* Wed Aug 15 2013 Max Mazur mmaxur@mirantis.com
- heat virtualenv bin files moved from openstack-heat into openstack-heat-virtualenv package
