Name:          openstack-heat-virtualenv-python-pastedeploy
Version:       1.5.0
Release:       1%{?dist}
Summary:       python-pastedeploy installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-pastedeploy for heat into virtualenv. Initial spec created.
