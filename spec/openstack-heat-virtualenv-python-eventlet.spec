Name:          openstack-heat-virtualenv-python-eventlet
Version:       0.13.0
Release:       1%{?dist}
Summary:       python-webo ionstalled into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       eventlet-%{version}.tar.gz
Source1:       openstack-heat-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-heat-virtualenv-python-greenlet-0.4.1-1.el6.noarch.rpm
...
Requires: openstack-heat-virtualenv-python-greenlet
...
# Cleanup    
rpm -e openstack-heat-virtualenv-python-greenlet
...
- python-eventlet for heat into virtualenv. Initial spec created.
