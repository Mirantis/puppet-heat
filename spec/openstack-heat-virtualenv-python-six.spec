Name:          openstack-heat-virtualenv-python-six
Version:       1.3.0
Release:       1%{?dist}
Summary:       python-six installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-six for heat into virtualenv. Initial spec created.
