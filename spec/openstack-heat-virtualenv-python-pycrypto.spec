Name:          openstack-heat-virtualenv-python-pycrypto
Version:       2.6
Release:       1%{?dist}
Summary:       python-pycrypto installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       pycrypto-%{version}.tar.gz
...
- python-pycrypto for heat into virtualenv. Initial spec created.
