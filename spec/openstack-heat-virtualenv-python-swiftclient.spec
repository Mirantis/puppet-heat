Name:          openstack-heat-virtualenv-python-swiftclient
Version:       1.5.0
Release:       1%{?dist}
Summary:       python-swiftclient ionstalled into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       python-swiftclient-%{version}.tar.gz
...
- python-swiftclient for heat into virtualenv. Initial spec created.
