Name:          openstack-heat-virtualenv-python-sqlalchemy
Version:       0.7.10
Release:       1%{?dist}
Summary:       python-sqlalchemy installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-sqlalchemy for heat into virtualenv. Initial spec created.
