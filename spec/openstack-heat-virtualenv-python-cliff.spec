Name:          openstack-heat-virtualenv-python-cliff
Version:       1.4.2
Release:       1%{?dist}
Summary:       python-cliff installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       cliff-%{version}.tar.gz
...
Source3:       openstack-heat-virtualenv-python-prettytable-0.7.2-1.el6.noarch.rpm
Source4:       openstack-heat-virtualenv-python-pyparsing-1.5.7-1.el6.noarch.rpm
Source5:       openstack-heat-virtualenv-python-cmd2-0.6.5.1-1.el6.noarch.rpm
...
- python-cliff for heat into virtualenv. Initial spec created.
