Name:          openstack-heat-virtualenv-python-ceilometerclient
Version:       1.0.3
Release:       1%{?dist}
Summary:       python-ceilometerclient ionstalled into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       python-ceilometerclient-%{version}.tar.gz
...
Source11:      openstack-heat-virtualenv-python-keystoneclient-0.3.1-1.el6.noarch.rpm
Source12:      openstack-heat-virtualenv-python-httplib2-0.8-1.el6.noarch.rpm
BuildArch:     noarch
...
Requires: openstack-heat-virtualenv-python-keystoneclient
...
# Cleanup
rpm -e openstack-heat-virtualenv-python-keystoneclient
...
- python-ceilometerclient for heat into virtualenv. Initial spec created.
