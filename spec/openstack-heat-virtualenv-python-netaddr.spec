Name:          openstack-heat-virtualenv-python-netaddr
Version:       0.7.10
Release:       1%{?dist}
Summary:       python-netaddr installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       netaddr-%{version}.zip
...
- python-netaddr for heat into virtualenv. Initial spec created.
