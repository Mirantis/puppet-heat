Name:          openstack-heat-virtualenv-python-anyjson
Version:       0.3.3
Release:       1%{?dist}
Summary:       python-anyjson installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       anyjson-%{version}.tar.gz
...
- python-anyjson for heat into virtualenv. Initial spec created.
