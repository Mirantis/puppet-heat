Name:          openstack-heat-virtualenv-python-jinja2
Version:       2.7.1
Release:       1%{?dist}
Summary:       python-jinja2 ionstalled into virtual env for openstack-heat
License:       ASL 2.0
...
%description
jinja2 in virtual environment for openstack-heat
...
- python-jinja2 for heat into virtualenv. Initial spec created.
