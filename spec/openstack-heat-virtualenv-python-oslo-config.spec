Name:          openstack-heat-virtualenv-python-oslo-config
Version:       1.1.1
Release:       1%{?dist}
Summary:       python-oslo-config installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       oslo.config-%{version}.tar.gz
...
- python-oslo-config for heat into virtualenv. Initial spec created.
