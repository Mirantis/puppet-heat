Name:          openstack-heat-virtualenv-python-pbr
Version:       0.5.21
Release:       1%{?dist}
Summary:       python-pbr installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       pbr-%{version}.tar.gz
...
- python-pbr for heat into virtualenv. Initial spec created.
