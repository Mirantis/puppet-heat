Name:          openstack-heat-virtualenv-python-tempita
Version:       0.5.1
Release:       1%{?dist}
Summary:       python-tempita installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       Tempita-%{version}.tar.gz
...
- python-tempita for heat into virtualenv. Initial spec created.
