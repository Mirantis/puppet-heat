Name:          openstack-heat-virtualenv-python-importlib
Version:       1.0.2
Release:       1%{?dist}
Summary:       python-importlib installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       importlib-%{version}.tar.bz2
...
- python-importlib for heat into virtualenv. Initial spec created.
