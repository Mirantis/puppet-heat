Name:          openstack-heat-virtualenv-python-sqlalchemy-migrate
Version:       0.7.2
Release:       1%{?dist}
Summary:       python-sqlalchemy-migrate installed into virtual env for openstack-heat
License:       ASL 2.0
...
Source3:       openstack-heat-virtualenv-python-decorator-3.4.0-1.el6.noarch.rpm
Source4:       openstack-heat-virtualenv-python-tempita-0.5.1-1.el6.noarch.rpm
...
Requires: openstack-heat-virtualenv-python-decorator
Requires: openstack-heat-virtualenv-python-tempita
...
# Cleanup    
rpm -e openstack-heat-virtualenv-python-tempita
rpm -e openstack-heat-virtualenv-python-decorator
...
- python-sqlalchemy-migrate for heat into virtualenv. Initial spec created.
