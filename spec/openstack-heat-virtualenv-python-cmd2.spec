Name:          openstack-heat-virtualenv-python-cmd2
Version:       0.6.5.1
Release:       1%{?dist}
Summary:       python-cmd2 installed into virtual env for openstack-heat
License:       ASL 2.0
URL:           https://launchpad.net/heat
Source0:       cmd2-%{version}.tar.gz
Source1:       openstack-heat-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-heat-virtualenv-python-pyparsing-1.5.7-1.el6.noarch.rpm
...
- python-cmd2 for heat into virtualenv. Initial spec created.
