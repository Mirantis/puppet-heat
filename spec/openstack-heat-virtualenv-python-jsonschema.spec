Name:          openstack-heat-virtualenv-python-jsonschema
Version:       1.3.0
Release:       1%{?dist}
Summary:       python-jsonschema installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-jsonschema for heat into virtualenv. Initial spec created.
