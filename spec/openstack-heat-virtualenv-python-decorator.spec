Name:          openstack-heat-virtualenv-python-decorator
Version:       3.4.0
Release:       1%{?dist}
Summary:       python-decorator installed into virtual env for openstack-heat
License:       ASL 2.0
...
- python-decorator for heat into virtualenv. Initial spec created.
